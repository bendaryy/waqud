...
<x-guest-layout>
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('users.store') }}">
            ...
            <div class="mt-4">
                <x-jet-label for="password_confirmation" class="text-center" value="{{ __('messages.password_confirmation') }}" />
                <x-jet-input id="password_confirmation" class="block mt-1 w-full" type="password" name="password_confirmation" required autocomplete="confirm-password" />
            </div>

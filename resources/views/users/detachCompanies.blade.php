     ...
     {{-- <div class="col-12">
             <div class="row">
                 <div class="form-group">
                     ...
                     <select class="js-example-basic-multiple" multiple style="width:100%" name="company[]">
                         ...
                         <tbody>
                             @foreach ($CompanyUser as $key => $company)
                                 <tr>
                                     ...
                                     <td>
                                         <form method='post' action="{{ route('detachCompanies', $company->id) }}">
                                             @method('delete')
                                             @csrf
                                             <button class="btn btn-danger" onclick="return confirm('@lang('messages.sure')');"
                                                 style="padding: 10px">@lang('messages.delete')</button>
                                         </form>
                                     </td>
                                 </tr>
                             @endforeach

    ...
    <div class="row">
        ...
        <div class="col-3">
            <button type="button" class="btn btn-success" style="padding: 20px;margin:20px" data-bs-toggle="modal"
                data-bs-target="#addRole">@lang('messages.addNewPermissions')</button>
        </div>
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header table-card-header">
                    <h4 style="color: white;text-align: center">@lang('messages.permissions')</h4>
                </div>
                <div class="card-block">
                    <div class="dt-responsive table-responsive">
                        <table id="basic-btn2" class="table table-bordered nowrap" style="color:white;text-align: center">
                            <thead>
                                <tr>
                                    <th id="thead">@lang('messages.permissions')</th>
                            ...
                            <tbody>
                                @foreach ($permissions as $persmission)
                                    <tr>
                                        <td>{{ $persmission->name }}</td>
                                        <td>
                                            <form method="post"  action="{{ route('permissions.destroy',$persmission->id) }}">
                                                @csrf
                                                @method('delete')
                                                <button style="padding: 10px" onclick="return confirm('@lang('messages.sure')');" class="btn btn-danger">@lang('messages.delete')</button>
                                            </form>
                                        </td>
                                    </tr>
                                @endforeach
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalLabel">@lang('messages.addNewPermissions')</h5>
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('permissions.store') }}">
                        ...
                        <div class="form-group">
                            <label for="permission-name" class="col-form-label">@lang('messages.persmissionName')</label>

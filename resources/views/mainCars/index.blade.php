    ...
    <div class="row">
        ...
        <div class="col-3">
            <button type="button" class="btn btn-success" style="padding: 20px;margin:20px" data-bs-toggle="modal"
                data-bs-target="#addRole">@lang('messages.add new car')</button>
        </div>
        ...
        <div class="col-12">
            ...
            <div class="card">
                <div class="card-header table-card-header">
                    <h4 style="color: white;text-align: center">@lang('messages.mainCars')</h4>
                </div>
                            ...
                            <tbody>
                                @foreach ($mainCars as $car)
                                    <tr>
                                        ...
                                        <td>
                                            <form method="post"
                                                action="{{ route('main-cars.destroy', $car->id) }}">
                                                @csrf
                                                @method('delete')
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalLabel">@lang('messages.add new car')</h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form method="post" action="{{ route('main-cars.store') }}">
                        @method('post')
                        @csrf
                        <div class="form-group">
                            <label for="permission-name" class="col-form-label">@lang('messages.car name')</label>

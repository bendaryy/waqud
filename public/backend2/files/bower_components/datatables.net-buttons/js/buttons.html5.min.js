(function (i) {
    ...
    function y(a, c) {
        s === p &&
            (s =
                ...
                v
                    .serializeToString(
                        i.parseXML(z["xl/worksheets/sheet1.xml"])
                    )
                    .indexOf("xmlns:r"));
    ...
    var u = function (a, c) {
            ...
            -1 !== d.indexOf("*") &&
                (d = i.trim(d.replace("*", i("title").text())));
    ...
    l.ext.buttons.csvHtml5 = {
        ...
        action: function (a, c, d, b) {
            ...
            !1 !== c
                ? (c || (c = k.characterSet || k.charset),
                  c && (c = ";charset=" + c))
                : (c = "");
            b.bom && (a = "﻿" + a);
            o(new Blob([a], { type: "text/csv" + c }), u(b), !0);
        },
        filename: "*",
        extension: ".csv",
        exportOptions: {},
    ...
    l.ext.buttons.excelHtml5 = {
        ...
        action: function (a, c, d, b) {
            var e = 0,
                ...
                d = function (a) {
                    ...
                    for (var b = 0, c = a.length; b < c; b++) {
                        for (var d = b, g = ""; 0 <= d; )
                            (g = String.fromCharCode((d % 26) + 65) + g),
                                (d = Math.floor(d / 26) - 1);
                        var d = g + "" + m,
                            j = null;
                        if (!(null === a[b] || a[b] === p || "" === a[b])) {
                            ...
                            for (var l = 0, o = H.length; l < o; l++)
                                if (
                                    ((g = H[l]),
                                    a[b].match && a[b].match(g.match))
                                ) {
                                    j = a[b].replace(/[^\d\.\-]/g, "");
                                    g.fmt && (j = g.fmt(j));
                                    j = n(f, "c", {
                                        attr: { r: d, s: g.style },
                                        children: [n(f, "v", { text: j })],
                                    });
                                    break;
                                }
                            j ||
            ...
            b.footer &&
                c.footer &&
                (d(c.footer, e), i("row:last c", f).attr("s", "2"));
            d = n(f, "cols");
            i("worksheet", f).prepend(d);
            j = 0;
            for (l = c.header.length; j < l; j++)
                d.appendChild(
                    n(f, "col", {
                        attr: {
                            min: j + 1,
            ...
            y(c, a);
            c.generateAsync
                ? c.generateAsync(d).then(function (a) {
                      o(a, u(b));
                  })
                : o(c.generate(d), u(b));
        },
    ...
    l.ext.buttons.pdfHtml5 = {
        ...
        action: function (a, c, d, b) {
            ...
            a = {
                ...
                content: [
                    { table: { headerRows: 1, body: e }, layout: "noBorders" },
                ],
                styles: {
                    tableHeader: {
                        bold: !0,

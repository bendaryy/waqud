F$(document).ready(function () {
  $("#print-btn").DataTable({ dom: "Bfrtip", buttons: ["print"] });
  $("#custom-print-msg").DataTable({
    dom: "Bfrtip",
    buttons: [
      {
        extend: "print",
        message: "List of total order in this month by Flat - Admin",
      },
    ],
  });
  $("#print-disable").DataTable({
    dom: "Bfrtip",
    buttons: [{ extend: "print", autoPrint: false }],
  });
  $("#print-column").DataTable({
    dom: "Bfrtip",
    buttons: [
  ...
  $("#file-export").DataTable({
    dom: "Bfrtip",
    buttons: [
      { extend: "excelFlash", filename: "my-Excel" },
      { extend: "pdfFlash", filename: "my-PDF" },
    ],
  });
  $("#flash-pdf-msg").DataTable({
    dom: "Bfrtip",
    buttons: [
      { extend: "pdfFlash", message: "PDF created by Buttons for DataTables." },
    ],
  });
  $("#flash-size").DataTable({
    dom: "Bfrtip",
    buttons: [
      { extend: "pdfFlash", orientation: "landscape", pageSize: "LEGAL" },
    ],
  });
  ...
  $("#pdf-open").DataTable({
    dom: "Bfrtip",
    buttons: [{ extend: "pdfHtml5", download: "open" }],
  });
  $("#pdf-json").DataTable({
    dom: "Bfrtip",
    buttons: [
  ...
  $("#class-btn").DataTable({
    ...
    buttons: [
      ...
      { text: "Inverse", className: "btn-inverse" },
    ],
  });
